...
url='https://www.spark.co.nz/shop/mobile/phones'
# /home/naufil/Desktop/chromedriver
driver = webdriver.Chrome()
driver.get(url)
html = driver.page_source

soup = BeautifulSoup(html, 'html.parser')
# phone_name = soup.find_all('div', {'class':'_2lebQ1R-ufCP5dNpJUTtep'}).text # phone name
# price_per_month = soup.find_all('div', {'class':'_3Cpr5ktg8eh2LI40eTZOYy'}).text # price per month
# interest = soup.find_all('div', {'class':'_19KqXVLwnv4Tdrl6Z5Caw4 _3skKfvMN7NMmiM_zTRFUde _2WLZkEZQFh-vi4QmWFOLG_'}).text # interest
# total_price = soup.find_all('div', {'class':'_1FykWgSNzyIy5hEGsGhj33'}).text # total_price
# unlimited_offer = soup.find_all('div', {'class':'_1lqQj4dE_WnGwWg3KfbDLU'}).text
